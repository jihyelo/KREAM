...
이지혜[FE] : 사이즈선택, 즉시구매/즉시판매, 구매입찰/판매입찰, 결제페이지 UI와 기능 구현 및 API 연동<br />
전미혜[FE] : 로그인/회원가입, 메인페이지, 상세페이지 UI와 기능 구현 및 API 연동<br />
김민수[BE] : ERD모델링, 메인페이지 리스트, 각 신발의 사이즈별 가격 구현<br />
최지준[BE] : ERD모델링, 경매 체결 API, 주문 페이지 구현<br />
양지은[BE] : 초기설정,PET분석, 회원가입 API, 상세정보 API<br />
홍지수[BE] : 데이터 수집 및 추가, 로그인 API, 상세정보 API
<br /><br />
